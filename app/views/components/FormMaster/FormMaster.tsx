...
const FormMaster = ({ titleSection, fields }: FormMaster) => {
        ...
        return (
            ...
            <div className="w-full lg:w-1/3 px-4 mb-10 lg:mb-0">
                ...
                <form action="">
                    <div className="mb-10">
                        <label
                            className="font-bold font-heading text-gray-100"
                            htmlFor=""
                        >
                            Email address
                        </label>
    ...
    const RequestTypes = () => {
        return (<div className="w-full lg:w-1/3 px-4 mb-10 lg:mb-0">


            <Header order={1} title="What are your passions?" />

            <div className="mb-12 pb-10 border-b">

                <p className="mb-3 font-bold font-heading text-gray-200">
                    Creative Arts
                </p>
                <div className="mb-6">
                    <label className="flex items-center" htmlFor="">
        ...
        return (
            <div className="w-full lg:w-1/3 px-4">
                ...
                <div>
                    ...
                    <textarea
                        className="mb-12 w-full resize-none border border-gray-200 focus:ring-blue-300 focus:border-blue-300 rounded-md"
                        name=""
                        id=""
                        cols={30}
                        rows={10}
