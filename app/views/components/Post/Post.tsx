            ...
            <div className="container px-4 mx-auto">
                ...
                <div className="max-w-4xl mx-auto">
                    <p className="text-xl font-extrabold leading-7 pb-12 mb-12 border-b-3 border-indigo-900">
                        We are a community of artists, builders and thinkers who are passionate
                    ...
                    <p className="text-xl font-extrabold leading-7 pb-12 mb-12 border-b-3 border-indigo-900">
                        ...
                        Nulla nisl sem, euismod ut eros vitae, egestas scelerisque enim. Vivamus
                        id pharetra massa. Nulla aliquet erat elit, a gravida dui efficitur vel.
                        Sed pulvinar diam sed neque ullamcorper semper. Nulla elementum arcu
                        lacus, quis porta nisl posuere varius. Quisque tempus libero sed urna
                        posuere hendrerit.
                    </p>
