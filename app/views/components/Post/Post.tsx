                ...
                <div className="max-w-4xl mx-auto mb-12 text-center">
...

                    {
                        tags ? tags.map((tag, index) => {
                            return (
                                <span key={index} className="inline-flex h-6 items-center justify-center text-xs font-extrabold px-2 text-indigo-900 rounded border border-indigo-900 bg-green-200 uppercase">
                                    {tag}
                                </span>
                            )
                        }) : <></>
