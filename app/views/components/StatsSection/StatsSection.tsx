        ...
        return (
            ...
            <div className="flex flex-wrap -mx-4">
                ...
                <div className="w-full lg:w-1/3 px-4 mb-12 lg:mb-0">
                    ...
                    <div className="max-w-md mx-auto border-3 border-indigo-900 rounded-2xl shadow-md">
                ...
                <div className="w-full lg:w-1/3 px-4 mb-12 lg:mb-0">
                    <div className="max-w-md h-full mx-auto border-3 border-indigo-900 rounded-2xl shadow-md">
                        <div className="px-6 pt-12 lg:px-12 pb-10 border-b-3 border-indigo-900">
